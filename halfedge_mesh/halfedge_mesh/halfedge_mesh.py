...
class HalfedgeMesh:
    ...
    def __hash__(self):
        return (
            hash(str(self.vertices))
            ^ hash(str(self.halfedges))
            ^ hash(str(self.facets))
        ...
        for index in range(number_facets):
            ...
            for i in range(3):
                ...
                if all_facet_edges[i][2::-1] in Edges:
                    ...
                    Edges[all_facet_edges[i][2::-1]].opposite = Edges[
                        all_facet_edges[i]
                    ]
    ...
    def parse_off(self, file_object):
        ...
        facets, Edges = self.parse_build_halfedge_off(
    ...
    def update_vertices(self, vertices):
        ...
        for he in self.halfedges:
            vi = he.vertex.index
            hlist.append(Halfedge(None, None, None, self.vertices[vi], None, he.index))
...
class Facet:
    ...
    def __eq__(self, other):
        return (
            ...
            and self.halfedge == other.halfedge
        )
...
class Halfedge:
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and (self.prev.vertex == other.prev.vertex)
            and (self.index == other.index)
        )
    ...
    def get_angle_normal(self):
        ...
        dir = [
            self.vertex.x - self.prev.vertex.x,
